...
class SurveyNew extends Component {
    ...
    onSubmit = async (event) => {
        ...
        var data = "country-code=SG&number=" + phone;
        var res;
        ...
        xhr.open("POST", "https://neutrinoapi-phone-validate.p.rapidapi.com/phone-validate");
        xhr.setRequestHeader("x-rapidapi-host", "neutrinoapi-phone-validate.p.rapidapi.com");
        xhr.setRequestHeader("x-rapidapi-key", "a92a80e875msh73b376aa2801ec5p1807bdjsn1824a55dd5c8");
        xhr.setRequestHeader("content-type", "application/x-www-form-urlencoded");

        xhr.send(data);

        await new Promise((resolve, reject) => setTimeout(resolve, 3000));  //Wait 3s then continue

        if (!res["valid"]) {
            alert("Your phone number is incorrect!! Please try again!!")
        } else {
            try{
